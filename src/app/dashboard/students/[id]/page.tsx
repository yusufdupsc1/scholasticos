...
export default async function StudentDetailsPage({
  ...
  const displayNameEn =
    student.studentNameEn ?? `${student.firstName} ${student.lastName}`.trim();
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <section className="rounded-lg border border-border bg-card p-4">
        ...
        <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
          ...
          <p>
            ...
            {student.class?.name ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("section")}:</span>{" "}
            {student.class?.section ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("roll")}:</span>{" "}
            {student.rollNo ?? na}
          </p>
          <p>
          ...
          <p>
            <span className="text-muted-foreground">{t("joined_on")}:</span>{" "}
            {formatLocalizedDate(student.createdAt, locale) ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("date_of_birth")}:</span>{" "}
            {formatLocalizedDate(student.dateOfBirth, locale) ?? na}
          </p>
          <p>
          ...
          <p>
            <span className="text-muted-foreground">{t("ward")}:</span>{" "}
            {student.ward ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("upazila")}:</span>{" "}
            {student.upazila ?? na}
          </p>
          <p>
      ...
      <section className="rounded-lg border border-border bg-card p-4">
        ...
        <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
          <p>
            <span className="text-muted-foreground">{t("guardian_name")}:</span>{" "}
            {student.guardianName ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("father_name")}:</span>{" "}
            {student.fatherName ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("mother_name")}:</span>{" "}
          ...
          <p>
            ...
            {student.guardianPhone ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("birth_reg_no")}:</span>{" "}
            {student.birthRegNo ?? na}
          </p>
          <p>
            <span className="text-muted-foreground">{t("nid_no")}:</span>{" "}
            {student.nidNo ?? na}
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
          <p>
            ...
            {student.guardianName ??
              (guardian ? `${guardian.firstName} ${guardian.lastName}` : na)}
          </p>
          <p>
            <span className="text-muted-foreground">{t("phone")}:</span>{" "}
            {student.guardianPhone ?? guardian?.phone ?? na}
          </p>
        </div>
      </section>
    </div>
